		...
		<c:choose>
			...
			<c:when test="${login }">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarResponsive" style="margin-left:490px;">
						<ul class="navbar-nav ml-auto" style="width:600px">
							...
							<li class="nav-item"><a class="nav-link" href="/inquiry/list">게시판</a></li>
